...
public class Amphipod2
{
    ...
    public Amphipod2(TextReader reader)
    {
        _reader = reader;
    }
    ...
    public class State
    {
        ...
        {
            const string line1a = "  #D#C#B#A#";
            const string line1b = "  #D#B#A#C#";
            Space[] spaces =
            {
                new Hallway(),
                new Hallway(),
                new SideRoom(Content.A, 4, Enum.Parse<Content>(line2.Substring(3, 1)), Enum.Parse<Content>(line1b.Substring(3, 1)), Enum.Parse<Content>(line1a.Substring(3, 1)), Enum.Parse<Content>(line1.Substring(3, 1))),
                new Hallway(),
                new SideRoom(Content.B, 4, Enum.Parse<Content>(line2.Substring(5, 1)), Enum.Parse<Content>(line1b.Substring(5, 1)), Enum.Parse<Content>(line1a.Substring(5, 1)), Enum.Parse<Content>(line1.Substring(5, 1))),
                new Hallway(),
                new SideRoom(Content.C, 4, Enum.Parse<Content>(line2.Substring(7, 1)), Enum.Parse<Content>(line1b.Substring(7, 1)), Enum.Parse<Content>(line1a.Substring(7, 1)), Enum.Parse<Content>(line1.Substring(7, 1))),
                new Hallway(),
                new SideRoom(Content.D, 4, Enum.Parse<Content>(line2.Substring(9, 1)), Enum.Parse<Content>(line1b.Substring(9, 1)), Enum.Parse<Content>(line1a.Substring(9, 1)), Enum.Parse<Content>(line1.Substring(9, 1))),
                new Hallway(),
                new Hallway()
            };
        ...
        public override string ToString()
        {
            ...
            result.Append('#').AppendJoin(string.Empty, _spaces.Select(s => !s.IsHallway() ? s.ToString()[3] : '#')).AppendLine("#");
            result.Append("  ").AppendJoin(string.Empty, _spaces.Skip(1).Take(_spaces.Length - 2).Select(s => !s.IsHallway() ? s.ToString()[2] : '#')).AppendLine();
            result.Append("  ").AppendJoin(string.Empty, _spaces.Skip(1).Take(_spaces.Length - 2).Select(s => !s.IsHallway() ? s.ToString()[1] : '#')).AppendLine();
