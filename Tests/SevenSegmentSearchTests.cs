...
namespace AdventOfCode2021.SevenSegmentSearch.Tests
{
    ...
    {
        [TestMethod]
        [DataRow("acedgfb cdfbe gcdfa fbcad dab cefabd cdfgeb eafb cagedb ab | cdfeb fcadb cdfeb cdbaf", 0)]
        ...
        public void GetUniqueNumberOfSegmentsDigitCount_Always_ReturnsExpectedResult(string input, int expectedResult)
        {
            // Arrange
