...
public class BeaconScanner
{
    public static void Main()
    {
        ...
        var beaconScanner = new BeaconScanner(reader);
        int result = beaconScanner.GetBeaconCount();
        Console.WriteLine(result);
    }

    private readonly TextReader _reader;

    public BeaconScanner(TextReader reader)
    {
        _reader = reader;
    }
    ...
    public int GetBeaconCount()
    {
        ...
        foreach (Scanner scanner in scanners)
        {
            ...
            foreach (var beacon in scanner.Transform(transforms))
            {
                beacons.Add(beacon);
            }
        }
